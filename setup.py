...
setup(
    ...
    url='https://github.com/Franck1333/CryptoWatch-Tkinter',
    license='lgpl',
    packages=find_packages(),
    include_package_data=False,
    install_requires=["pydub","cmc","pandas","numpy","matplotlib"], #Get the Dependencies from Pypi (pip install)
